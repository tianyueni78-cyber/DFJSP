function config = stage_br_complete_search_config(projectRoot)
%STAGE_BR_COMPLETE_SEARCH_CONFIG Configure the single-seed formal run.
...
config.output_root = fullfile(projectRoot, 'outputs', ...
    'stage_br_complete_reschedule_search');
end
