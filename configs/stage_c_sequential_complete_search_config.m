function config = stage_c_sequential_complete_search_config(projectRoot)
%STAGE_C_SEQUENTIAL_COMPLETE_SEARCH_CONFIG Configure the formal run.
...
config.seed = 42;
config.run_type = 'single_seed_sequential_formal_search';
config.output_root = fullfile(projectRoot, 'outputs', ...
    'stage_c_sequential_complete_reschedule_search');
end
