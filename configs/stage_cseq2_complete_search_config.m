function config = stage_cseq2_complete_search_config(projectRoot)
%STAGE_CSEQ2_COMPLETE_SEARCH_CONFIG Configure the formal C-SEQ2 run.
...
config.seed = 42;
config.run_type = 'single_seed_cseq2_formal_search';
config.output_root = fullfile(projectRoot, 'outputs', ...
    'stage_cseq2_complete_reschedule_search');
end
