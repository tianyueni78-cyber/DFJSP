function scenario = run_stage_b_restricted_search_contract(baseline)
%RUN_STAGE_B_RESTRICTED_SEARCH_CONTRACT Run a tiny deterministic search.
...
scenario.restricted_search = search_stage_b_complete_reschedule( ...
