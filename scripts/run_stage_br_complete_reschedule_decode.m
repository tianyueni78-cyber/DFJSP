function scenario = run_stage_br_complete_reschedule_decode(baseline)
%RUN_STAGE_BR_COMPLETE_RESCHEDULE_DECODE Decode one Stage B-R source seed.
...
scenario.complete_reschedule_candidate = ...
    decode_stage_br_complete_reschedule( ...
    scenario.baseline, scenario.frozen_problem, ...
    scenario.complete_reschedule_seed);
scenario.step = 7;
