function analysis = analyze_stage_cs2_weight_sensitivity( ...
        baseline, state, rightShift, completeSearch, weights)
%ANALYZE_STAGE_CS2_WEIGHT_SENSITIVITY Re-evaluate fixed C-S2 candidates.

if nargin < 5
    error('analyze_stage_cs2_weight_sensitivity:MissingInput', ...
...
if isempty(weights) || any(~isfinite(weights)) || ...
    ...
    error('analyze_stage_cs2_weight_sensitivity:Weights', ...
...
if ~result
    error('analyze_stage_cs2_weight_sensitivity:InvalidResult', ...
