function evaluation = evaluate_stage_c_simultaneous_reschedule_candidate( ...
        baseline, frozen, decision)
%EVALUATE_STAGE_C_SIMULTANEOUS_RESCHEDULE_CANDIDATE Decode and score one decision.
%   Objectives are final-unload makespan and corrected total energy. All
%   interrupted operations use the Stage C multiple-split decoder.
...
evaluation.is_multiple_interruption_evaluated = ...
    candidate.is_stage_c_multiple_split_operation_decoded;
